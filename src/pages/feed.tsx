        ...
        <div className='bg-gray-100 max-w-[1380px] px-10 mx-auto h-screen flex gap-5 pt-5 overflow-hidden'> 
            ...
            <div className='flex-1 space-y-5 overflow-y-auto scrollbar-hide h-[calc(100vh-100px)] pb-5'> {/* will remove this width after middle and right part completion */}
                ...
                <div className='space-y-5 bg-white p-6 rounded-lg'>
                    <h3 className='text-black font-medium text-2xl'>Explore</h3>

                    {/* links */}
                    <div className='text-gray-600 space-y-5'>
                        <Link to="/link1" className='flex gap-4 items-center'>
                        ...
                        <Link to="/link2" className='flex gap-4 items-center'>
                        ...
                        <Link to="/link3" className='flex gap-4 items-center'>
                            <svg xmlns="http://www.w3.org/2000/svg" width="22" height="24" fill="none" viewBox="0 0 22 24">
                        ...
                        <Link to="/link4" className='flex gap-4 items-center'>
                        ...
                        <Link to="/link5" className='flex gap-4 items-center'>
                            <svg xmlns="http://www.w3.org/2000/svg" width="22" height="24" fill="none" viewBox="0 0 22 24">
                        ...
                        <Link to="/link6" className='flex gap-4 items-center'>
                            <svg xmlns="http://www.w3.org/2000/svg" width="22" height="24" fill="none" viewBox="0 0 22 24">
                        ...
                        <Link to="/link7" className='flex gap-4 items-center'>
                        ...
                        <Link to="/link8" className='flex gap-4 items-center'>
                ...
                <div className="bg-white rounded-lg p-5 shadow-sm">
                    <div className="flex items-center justify-between mb-4">
                        <h3 className="text-black font-semibold text-xl">Suggested People</h3>
                        <Link to="/see-all" className="text-blue-500 text-sm font-medium hover:underline cursor-pointer">See All</Link>
                    </div>
                    <div className="space-y-5">
                        {/* Person 1 */}
                        <UserSuggestion profilePic={profilePic} name="Steve Jobs" title="CEO of Apple"></UserSuggestion>
                        {/* Person 2 */}
                        <UserSuggestion profilePic={profilePic} name="Steve Jobs" title="CEO of Apple"></UserSuggestion>
                ...
                <div className="bg-white rounded-lg p-5 shadow-sm">
                    ...
                    <div className="space-y-5">
                    <EventCard
                        image={'https://images.unsplash.com/photo-1506744038136-46273834b3fb?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8M3x8ZXZlbnR8ZW58MHx8MHx8fDA%3D&w=1000&q=80'}
                        date="10"
                        month="Jul"
            ...
            <div className='space-y-5 max-w-[660px] overflow-y-auto scrollbar-hide h-[calc(100vh-100px)] pb-10'>
                ...
                <div className='flex gap-5 w-[660px] overflow-x-auto whitespace-nowrap scrollbar-hide'>
                    {/* my story card */}
                    <div className="relative w-[140px] h-[155px] rounded-sm overflow-hidden shadow bg-b shrink-0 flex flex-col items-center " style={{backgroundImage:`url(${storyPic1})` , backgroundRepeat: 'no-repeat', backgroundSize: 'cover'}}>
                            {/* <img src={storyPic1} alt="Your Story" className="w-full h-[90px] object-cover" /> */}
                            <div className="absolute left-0 right-0 bottom-0 h-[60px] bg-[#14213d] flex flex-col items-center justify-center rounded-t-4xl">
                                <div className="flex items-center justify-center w-10 h-10 bg-blue-500 rounded-full border-3 border-[#14213d] absolute -top-5 left-1/2 -translate-x-1/2">
                                    <MdAdd className="text-white text-2xl" />
                                </div>
                                <div className="pt-6 text-white font-semibold text-base">Your Story</div>
                            </div>
                    </div>      

                    <StoryCard background={storyPic1} profilePic={profilePic} name="Elon Musk"></StoryCard>
                    <StoryCard background={storyPic1} profilePic={profilePic} name="Elon Musk"></StoryCard>
                    <StoryCard background={storyPic1} profilePic={profilePic} name="Elon Musk"></StoryCard>
            ...
            <div className='flex-1 space-y-5 overflow-y-auto scrollbar-hide h-[calc(100vh-100px)] pb-5'>
                ...
                {/* explore section */}
                <div className='space-y-5 bg-white p-6 rounded-lg'>
                    <div className="flex items-center justify-between mb-4 border-b pb-5 border-gray-200">
                        <h3 className="text-black font-semibold text-xl">You Might Like</h3>
                        <Link to="/see-all" className="text-blue-500 text-sm font-medium hover:underline cursor-pointer">See All</Link>
                    </div>
                    
                    
                    {/* might like components */}
                    <div>
                        <MightLike profilePic={profilePic} name="Elon Musk" title="CEO of Tesla"></MightLike>
                ...
                <div className="bg-white rounded-lg p-5 shadow-sm">
                    <div className="flex items-center justify-between mb-4">
                        <h3 className="text-black font-semibold text-xl">Your Friends</h3>
                        <Link to="/see-all" className="text-blue-500 text-sm font-medium hover:underline cursor-pointer">See All</Link>
                    </div>

                    {/* search bar */}
                    <div className="flex items-center gap-3 bg-white rounded-full shadow-sm px-4 py-2 border border-gray-200 mb-8">
                        <FiSearch className="text-gray-400 text-lg" />
                        <input
                          type="text"
                          className=" max-w-[350px] outline-none placeholder-gray-400 text-sm"
                    ...
                    <div className="space-y-8">
                        {/* Person 1 */}
                        <ShowFriend profilePic={profilePic} name="Steve Jobs" title="CEO of Apple" isActive={true}></ShowFriend>
                        {/* Person 2 */}
                        <ShowFriend profilePic={profilePic} name="Steve Jobs" title="CEO of Apple" isActive={false} lastSeen="5 min ago"></ShowFriend>
                        {/* Person 1 */}
                        <ShowFriend profilePic={profilePic} name="Steve Jobs" title="CEO of Apple" isActive={true}></ShowFriend>
                        {/* Person 2 */}
                        <ShowFriend profilePic={profilePic} name="Steve Jobs" title="CEO of Apple" isActive={false} lastSeen="5 min ago"></ShowFriend>
