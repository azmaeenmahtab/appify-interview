...
const Feed = () => {
    ...
    <div className='bg-gray-100 '> 
        <Navbar />
        {/* left side div */}
        <div className='bg-gray-100 max-w-[1380px] px-10 mx-auto h-screen overflow-y-auto scrollbar-hide'> 
            <div className='max-w-[290px] space-y-5 pt-5'> {/* will remove this width after middle and right part completion */}
